...
from custom_components.cookiecutter_homeassistant_custom_component_instance.api import CookiecutterHomeassistantCustomComponentInstanceApiClient
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = CookiecutterHomeassistantCustomComponentInstanceApiClient("test", "test", async_get_clientsession(hass))
